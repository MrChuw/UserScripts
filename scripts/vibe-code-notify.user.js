...
(function () {
    ...
    const REMOTE_RULES_URL = 'https://gist.githubusercontent.com/MrChuw/e66f574692da9d32f5632061ec261ce2/raw/slop_extensions.txt'; // Other rules one per line
    ...
    async function updateRules() {
            ...
            if (rawRemote) {
                ...
                } catch (e) { log('Cache parse error', e); }
            }
            if (useNetwork && REMOTE_RULES_URL) {
                ...
                } catch (e) { log('Rules fetch failed', e); }
            }
    ...
    function showPopout(repoKey) {
        ...
        Object.assign(container.style, {
            ...
            zIndex: '99999', maxWidth: '380px', boxShadow: '0 8px 24px rgba(0,0,0,0.2)',
        ...
        Object.assign(card.style, {
            ...
            border: '1px solid rgba(27,31,35,0.08)', padding: '16px'
        });
        ...
        Object.assign(closeBtn.style, { border: 'none', background: 'transparent', cursor: 'pointer', fontSize: '14px' });
        ...
        Object.assign(actions.style, { marginTop: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' });

        // Checkbox
        const left = document.createElement('label');
        Object.assign(left.style, { display: 'flex', alignItems: 'center', fontSize: '12px', cursor: 'pointer', color: '#57606a' });
        ...
        Object.assign(exitBtn.style, {
            border: '1px solid rgba(209, 36, 47, 0.3)', background: '#fff', color: '#cf222e',
            padding: '6px 12px', borderRadius: '6px', cursor: 'pointer', fontWeight: '500'
        });
        exitBtn.onclick = () => { window.location.href = 'https://github.com'; };

        const okBtn = document.createElement('button');
        okBtn.textContent = 'Stay';
        Object.assign(okBtn.style, {
            border: '1px solid rgba(27,31,35,0.15)', background: '#f6f8fa', color: '#24292f',
            padding: '6px 12px', borderRadius: '6px', cursor: 'pointer', fontWeight: '500'
        });
        okBtn.onclick = () => {
